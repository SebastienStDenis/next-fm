    ...
    >
      {variant === "default" && (
        <span
          ref={indicatorRef}
          aria-hidden="true"
          className="absolute top-0 left-0 rounded-md bg-primary opacity-0 shadow-sm transition-[transform,width,height] duration-200 ease-out motion-reduce:transition-none"
        />
      )}
      {children}
    </TabsPrimitive.List>
